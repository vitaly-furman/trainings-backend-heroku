...
import { getWorkersRequestSchema, createWorkerRequestSchema, deleteWorkerRequestSchema } from './validator.schema';
...
workerRouter.put('/', ValidateRequest(createWorkerRequestSchema), wrapController(WorkerController.updateWorker));
