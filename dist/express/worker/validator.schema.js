...
exports.createWorkerRequestSchema = exports.deleteWorkerRequestSchema = exports.getWorkersRequestSchema = void 0;
...
exports.deleteWorkerRequestSchema = Joi.object({
    query: {
        workerId: Joi.string(),
    },
    body: {},
